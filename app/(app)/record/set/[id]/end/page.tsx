...
import { SetEndFlow } from './set-end-flow'
import type { Preset, Session, Hanchan } from '@/lib/types'

export default async function SetEndPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <SetEndFlow session={session} hanchans={hanchans} userId={user.id} />
}
